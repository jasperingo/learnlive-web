           ...
           <section class="container-fluid">
                ...
                <div class="col-md-8 d-flex align-items-center py-5 position-fixed top-0 end-0 bottom-0 overflow-auto">
                    ...
                    <form class="login-form shadow rounded px-3 py-5 m-auto" method="POST" action="">
                        ...
                        <div class="mb-3">
                            <label for="number_input" class="small">Personnel number</label>
                            <input type="text" name="personnel_number" id="number_input" 
                                   class="form-control <%= data.hasError("personnel_number") ? "is-invalid" : "" %>" 
                                   value="<%= data.getData("personnel_number")%>" required="" />
                            <div class="invalid-feedback"><%= data.getError("personnel_number")%></div>
                        </div>

                        <div class="mb-3">
                            <button type="submit" class="btn bg-violent text-white w-100 rounded-pill text-center">Continue</button>
                        </div>
