           ...
           <section class="container-fluid">
                ...
                <div class="col-md-8 d-flex align-items-center py-5 position-fixed top-0 end-0 bottom-0 overflow-auto">
                    ...
                    <form class="login-form shadow rounded px-3 py-5 m-auto" method="POST" action="">
                         ...
                         <h2 class="fs-4 mb-3 text-center text-violent fw-bold">Login as a lecturer</h2>
                         ...
                         <div class="mb-3">
                            ...
                            <input type="text" name="personnel_number" id="number_input" class="form-control" 
                         ...
                         <div class="mb-3">
                             ...
                             <a href="lecturer/register">Register</a>
                         </div>
